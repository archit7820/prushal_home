...
BAIF Road, wagoli Pune - 412207
          ...
          <div className="social-links">
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer"><img src="instagram.png" alt="Instagram Logo" width={50} height={50} /></a>
            <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer"><img className="social-link_1" src="linkedin.png" alt="LinkedIn Logo" width={50} height={50} /></a>
            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer"><img  className="social-link_1" src="twitter.png" alt="LinkedIn Logo" width={50} height={50} /></a>
          </div>
        </div>
      </div>
